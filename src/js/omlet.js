...
Omlet.isInstalled = function(ignoreLegacy) {
  ...
  document.getElementById("console").textContent=  document.cookie ;
...
Omlet.getParameterByName = function(name) {
    document.getElementById("console").textContent +=  " location: " + location ;
...
if (Omlet.isInstalled(true)) {
  ...
  document.getElementById("console").textContent +=  " itoken: " + instanceToken ;
    // Basic API
