...
function getMedia(){
  getUserMedia( { "audio":false, "video":{mandatory: { minFrameRate: 30, maxHeight: 240, maxWidth: 320}}} , streaming, logError ) ;
}
...
//   } 
//   else {
//     initConnection(false, true, true) ;
